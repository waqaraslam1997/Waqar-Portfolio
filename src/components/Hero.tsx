      ...
      <div className="container mx-auto">
        <div className="flex justify-between gap-x-8">
          ...
          <div className="flex flex-col max-w-[600px] justify-center mx-auto xl:mx-0 text-center xl:text-left">
            ...
            <p className="subtitle max-w-[490px] mx-auto xl:mx-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim esse minus magni placeat amet deleniti molestiae libero aliquid molestias numquam ad natus sapiente tenetur dicta autem porro, alias iure veritatis.
            </p>
            {/* Button */}
