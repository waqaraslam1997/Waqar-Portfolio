...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex tems-center justify-center xl:bg-white rounded-[30px] dark:md:bg-secondary p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
